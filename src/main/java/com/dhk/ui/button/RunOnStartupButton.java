...
public class RunOnStartupButton extends JButton {
     ...
     *                                               Windows.
     * @param runOnStartupEnabledIdleIconPath        - The resource path for the run on startup button enabled idle
     *                                               icon.
     * @param runOnStartupDisabledIdleIconPath       - The resource path for the run on startup button disable idle
     *                                               icon.
     * @param runOnStartupEnabledDarkHoverIconPath   - The resource path for the run on startup button enabled hover
     *                                               dark icon.
     * @param runOnStartupEnabledLightHoverIconPath  - The resource path for the run on startup button enabled hover
     *                                               light icon.
     * @param runOnStartupDisabledDarkHoverIconPath  - The resource path for the run on startup button disabled hover
     *                                               dark icon.
     * @param runOnStartupDisabledLightHoverIconPath - The resource path for the run on startup button disabled hover
     *                                               light icon.
     */
