...
public class ClearAllButton extends JButton {
	...
	public ClearAllButton (String clearAllIdleIconPath, String clearAllHoverIconPath) {
		...
		clearAllIdleIcon = new FlatSVGIcon(getClass().getResource(clearAllIdleIconPath))
				.derive(0.75f);
		clearAllHoverIcon = new FlatSVGIcon(getClass().getResource(clearAllHoverIconPath))
				.derive(0.75f);
		clearAllPressedIcon = new FlatSVGIcon(getClass().getResource(clearAllHoverIconPath))
				.derive(0.60f);
