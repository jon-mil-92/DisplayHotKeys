...
public class SettingsValidator {
	...
	/**
	 * This method validates the value for each key property from the settings file. If the value is not a 
	 * valid value, then it writes the default value for the key property.
	 */
